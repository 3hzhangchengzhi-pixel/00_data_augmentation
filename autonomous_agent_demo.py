...
Examples:
  ...
  python autonomous_agent_demo.py --project-dir ./data_pipeline --model claude-sonnet-4-5-20250929

  # Limit iterations for testing
  python autonomous_agent_demo.py --project-dir ./data_pipeline --max-iterations 5
